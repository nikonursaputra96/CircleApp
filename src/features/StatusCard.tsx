...
const StatusCard = (data: IThread): React.JSX.Element => {
  ...
  const date = format(postedAt, 'MMM d, yyy')
  const time = format(postedAt, 'h:mm a')
    ...
    <Box>
      <Flex ml="20px" color="white" mt="15px">
        ...
        <Flex flexDirection="column">
          <Flex fontSize="14px" ml={3} flexDirection={"column"}>
          ...
          <Flex fontSize="14px" ml={3} mt={2}>
            <Text color="rgba(144, 144, 144, 1)">{time}</Text>
            <Text color="rgba(144, 144, 144, 1)" mx={1}>•</Text>
            <Text color="rgba(144, 144, 144, 1)">{date}</Text>
          </Flex>
